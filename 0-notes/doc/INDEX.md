...
| [architecture.md](architecture.md) | Modules, invariants, démon, watcher, hooks git, .gitignore, tests | on modifie le code de coutcouticket, on ajoute un champ ou un outil, on touche au démon (démarrage, plist launchd, journal), aux hooks git ou à init |
