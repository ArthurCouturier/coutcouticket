...
| [architecture.md](architecture.md) | Modules, invariants, démon, watcher, hooks git, tests | on modifie le code de coutcouticket, on ajoute un champ ou un outil, on touche au démon ou aux hooks git |
